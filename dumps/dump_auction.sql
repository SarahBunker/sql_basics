...
--
-- Name: bidders; Type: TABLE; Schema: public; Owner: ec2-user
--
...
ALTER TABLE public.bidders OWNER TO "ec2-user";

--
-- Name: bidders_id_seq; Type: SEQUENCE; Schema: public; Owner: ec2-user
--
...
ALTER TABLE public.bidders_id_seq OWNER TO "ec2-user";

--
-- Name: bidders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ec2-user
--
...
--
-- Name: bids; Type: TABLE; Schema: public; Owner: ec2-user
--
...
--
-- Name: items; Type: TABLE; Schema: public; Owner: ec2-user
--
...
ALTER TABLE public.items OWNER TO "ec2-user";

--
-- Name: items_id_seq; Type: SEQUENCE; Schema: public; Owner: ec2-user
--
...
ALTER TABLE public.items_id_seq OWNER TO "ec2-user";

--
-- Name: items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ec2-user
--
...
--
-- Name: bidders id; Type: DEFAULT; Schema: public; Owner: ec2-user
--
...
--
-- Name: bids id; Type: DEFAULT; Schema: public; Owner: ec2-user
--
...
--
-- Name: items id; Type: DEFAULT; Schema: public; Owner: ec2-user
--
...
--
-- Data for Name: bidders; Type: TABLE DATA; Schema: public; Owner: ec2-user
--
...
--
-- Name: bidders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ec2-user
--
...
--
-- Data for Name: items; Type: TABLE DATA; Schema: public; Owner: ec2-user
--
...
--
-- Name: items_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ec2-user
--
...
--
-- Name: bidders bidders_pkey; Type: CONSTRAINT; Schema: public; Owner: ec2-user
--
...
--
-- Name: bids bids_pkey; Type: CONSTRAINT; Schema: public; Owner: ec2-user
--
...
--
-- Name: items items_pkey; Type: CONSTRAINT; Schema: public; Owner: ec2-user
--
...
--
-- Name: bids_mm_idx; Type: INDEX; Schema: public; Owner: ec2-user
--

CREATE INDEX bids_mm_idx ON public.bids USING btree (bidder_id, item_id);


--
-- Name: bids bids_bidder_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ec2-user
--
...
--
-- Name: bids bids_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ec2-user
--
