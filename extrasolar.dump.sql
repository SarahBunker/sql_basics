...
CREATE TABLE public.stars (
    ...
    CONSTRAINT stars_companion_check CHECK ((companions >= 0)),
...
INSERT INTO public.planets VALUES (1, 'b', 0.0036, 1, -14);
INSERT INTO public.planets VALUES (2, 'c', 0.1, 2, -14);
...
--
-- Name: planets planets_designation_key; Type: CONSTRAINT; Schema: public; Owner: ec2-user
--
...
--
-- Name: planets planets_stars_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ec2-user
--
